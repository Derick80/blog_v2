  ...
  return (
    <Portal wrapperId='modal'>
      ...
      <div className='pointer-events-none fixed inset-0 flex max-h-screen items-center justify-center overflow-scroll'>
        <div
          className={`${className}pointer-events-auto relative h-full max-h-screen w-full max-w-2xl overflow-y-auto border-2 border-white p-4 md:h-auto md:rounded-xl`}
        >
