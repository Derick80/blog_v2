...
export default function Comment({id, message, user, createdAt}: {id: string, message: string, user: User, createdAt: string}){
...
<span className="text-xs">{user.userName}</span>
            <span className="text-xs">{format(new Date(createdAt
            ), 'MMM dd,')}</span>
        </div>
        <div className="flex flex-col space-y-2">
        {isEditing ? (
