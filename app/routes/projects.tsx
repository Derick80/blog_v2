...
<div className='flex w-[350px] flex-col items-center gap-5 rounded-md border-2 p-2'>
  ...
  <div className='flex flex-col gap-2'>
    ...
    <div className='flex flex-col gap-2'>
      ...
      />
      <p className='indent-1 text-base prose-invert'>A personal blog built with Remix and Typescript. This was the first first largely non-tutorial app that I built</p>
      <div className='flex flex-col w-full justify-between gap-5 p-1'>
...
<div className='flex w-[350px] flex-col items-center gap-5 rounded-md border-2 p-2'>
  ...
  <div className='flex flex-col gap-2'>
    <p className='text-base font-semibold'>Technologies</p>
    <div className='flex flex-col gap-2'>
      <div className='ml-1 flex flex-row items-center gap-2 flex-wrap'>
      <div className='rounded-sm border p-1'>
                <p className='text-base'>React</p>
...
<div>
      ...
      <div className='flex flex-col w-full justify-between gap-5 p-1'>
        ...
        <ul className='indent-2'>
          <li className='flex items-center space-x-1'>
            <p className='text-base '>Implimentation of typescript and css</p>
          </li>
