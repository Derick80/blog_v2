...
const btn_outline = `bg-slate-100 border shadow-sm text-slate-500 border-slate-200 hover:bg-slate-700
        hover:border-red-300  dark:text-slate-300 dark:bg-slate-800 dark:border-slate-700  dark:hover:border-sky-300`

const btn_solid = `bg-slate-700 border shadow-sm text-slate-900 dark:text-slate-100 dark:border-none border-slate-700 hover:bg-slate-800`
const btn_success = `bg-green-500 shadow-sm text-slate-900 dark:text-slate-100 border-green-500 hover:bg-green-600`
...
export default function Index() {
  return (
    <div className='flex min-h-screen flex-row items-center justify-center py-2'>
      ...
      <div className='flex h-full w-full flex-row border-2 bg-slate-100 text-slate-900'>
        <div className='min-h-screen p-2'>
          Light
          <ul>
            Base
